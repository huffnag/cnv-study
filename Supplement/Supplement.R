...
write_clip(rbind(
  tidy(glm(Psychosis_Spectrum~pTS+sex+race2+envSES,cnv.psych,family = 'binomial'))[2,],
  tidy(glm(ADHD~pTS+sex+race2+envSES,cnv.psych,family = 'binomial'))[2,],
  tidy(glm(AnyAnxietyDis~pTS+sex+race2+envSES,cnv.psych,family = 'binomial'))[2,],
  tidy(glm(Depression~pTS+sex+race2+envSES,cnv.psych,family = 'binomial'))[2,]))
